    ...
    implements Comparable, Serializable
{
    ...
    private void init(String name)
    {
        ...
        Class cls = getClass();
        boolean ok = false;
        for(; cls != null && cls != (org.apache.commons.lang.enums.Enum.class) && cls != (org.apache.commons.lang.enums.ValuedEnum.class); cls = cls.getSuperclass())
        {
            if(cls != enumClass)
                continue;
            ok = true;
    ...
    private static Entry getEntry(Class enumClass)
    {
        ...
        if(!(org.apache.commons.lang.enums.Enum.class).isAssignableFrom(enumClass))
        {
    ...
    private static Entry createEntry(Class enumClass)
    {
        ...
        for(Class cls = enumClass.getSuperclass(); cls != null && cls != (org.apache.commons.lang.enums.Enum.class) && cls != (org.apache.commons.lang.enums.ValuedEnum.class); cls = cls.getSuperclass())
        {
