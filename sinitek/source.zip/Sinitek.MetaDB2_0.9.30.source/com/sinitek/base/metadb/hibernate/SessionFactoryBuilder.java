...
public class SessionFactoryBuilder
{
        ...
        throws MetaDBException
    {
        ...
        if(MetaDBContext.TYPE == 0)
            configProp.setProperty("hibernate.dialect", "com.sinitek.base.metadb.hibernate.XNOracle9iDialect");
        else
            configProp.setProperty("hibernate.dialect", "com.sinitek.base.metadb.hibernate.XNMySQL5Dialect");
    ...
    private static Column createColumn(IProperty prop, Table table, GlobalConfig config)
    {
        ...
        column.setName(DBUtils.isKeyWord(prop.getPropertyColumnName()) ? (new StringBuilder()).append("[").append(prop.getPropertyColumnName()).append("]").toString() : prop.getPropertyColumnName());
