...
//            IMethodInvocationInfo, IMetaDBContextSupport, ContextInvocationInfo, IExceptionHandler, 
//            GetMetaDBContextHelper, ContextInvocationInfoContainer, TransactionType, IExceptionTranslator
    ...
    implements InvocationHandler
{
        ...
        throws Throwable
    {
        ...
        his = ContextInvocationInfoContainer.getCurrentContext();
        if(his == null)
        ...
        {
            isNeedCloss = his.isCurrentMethodOpenContext();
        }
        isNeedCloss = his.isCurrentMethodOpenContext();
