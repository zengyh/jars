...
public class SynServerConfig
{
        ...
        throws SynCenterException
    {
        ...
        Properties cfgProp;
        Exception exception;
        File _cfgFile = new File(cfgFile);
        if(!_cfgFile.exists())
        ...
        throw exception;
        return loadConfig(cfgProp);
    }

    public static SynServerConfig loadConfig(Properties cfgProp)
    {
        ...
        if(ret.databaseConnectType == DBConnectType.JNDI)
        {
            String jndi = cfgProp.getProperty("synserver.jndidatasourcename", "");
            if(StringUtils.isBlank(jndi))
                throw new SynCenterServerException("0001", new Object[] {
                    "\u6CA1\u6709\u914D\u7F6Esynserver.jndidatasourcename\uFF0C\u8BE5\u53C2\u6570\u5728\u4F7F\u7528jndi\u6570\u636E\u6E90\u6A21\u5F0F\u4E0B\u5FC5\u987B\uFF0C\u8868\u793Ajndi\u6570\u636E\u6E90\u540D\u79F0"
                });
            LOGGER.debug((new StringBuilder()).append("\u914D\u7F6E\u7684jndi\u6570\u636E\u6E90\u540D\u79F0\u4E3A\uFF1A[").append(jndi).append("]").toString());
            _factory.setDbConnectType(ret.databaseConnectType);
            _factory.setJndi(jndi);
        } else
        {
            throw new SynCenterServerException("0001", new Object[] {
