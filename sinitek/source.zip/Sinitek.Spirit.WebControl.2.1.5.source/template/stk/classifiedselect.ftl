...
>
    <div class='stk-input-search-extra-st2' id="${parameters.id?html}" style="<#rt/>
...
<script type="text/javascript">
    ...
    function ${parameters.id}_init(callBack)
    {
        ...
        var options = {
            ...
            allowSelectClass:'${parameters.allowSelectClass}'
        };
        var param = {};
    ...
    <#if parameters.sDefaultValue?if_exists != "">
        ...
        SpiritSelectorAction.genClassifiedSelector(options, param, {
            callback:function(result) {
                stk.classifiedSelector.init("${parameters.id}", result, options);
