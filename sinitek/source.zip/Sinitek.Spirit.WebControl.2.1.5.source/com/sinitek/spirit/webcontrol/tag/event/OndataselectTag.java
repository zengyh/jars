...
// Source File Name:   OndataselectTag.java
...
//            AbsEventTag, Ondataselect

public class OndataselectTag extends AbsEventTag
{

    public OndataselectTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Ondataselect(stack, req, res);
    }
