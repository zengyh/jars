...
// Source File Name:   OniconclickTag.java
...
//            AbsEventTag, Oniconclick

public class OniconclickTag extends AbsEventTag
{

    public OniconclickTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Oniconclick(stack, req, res);
    }
