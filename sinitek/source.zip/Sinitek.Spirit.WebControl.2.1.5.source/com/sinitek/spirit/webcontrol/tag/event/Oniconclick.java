...
// Source File Name:   Oniconclick.java
...
public class Oniconclick extends AbsEvent
{

    public Oniconclick(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    {
        return "event-iconclick";
    }

    protected String getDefaultTemplate()
    {
        return "event-iconclick-close";
    }

    public void evaluateExtraParams()
    {
        super.evaluateExtraParams();
        addProperty("eventName", "iconclick");
    }
    ...
    private static final String TEMPLATE = "event-iconclick";
    private static final String TEMPLATE_CLOSE = "event-iconclick-close";
}
