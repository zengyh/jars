...
// Source File Name:   Onwindowclose.java
...
public class Onwindowclose extends AbsEvent
{

    public Onwindowclose(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    {
        return "event-onwindowclose-close";
    }

    public void evaluateExtraParams()
    {
        super.evaluateExtraParams();
        addProperty("eventName", "close");
    }
    ...
    private static final String TEMPLATE = "event-onwindowclose";
    private static final String TEMPLATE_CLOSE = "event-onwindowclose-close";
}
