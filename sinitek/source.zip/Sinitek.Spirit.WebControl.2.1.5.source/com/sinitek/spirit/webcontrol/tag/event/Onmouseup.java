...
// Source File Name:   Onmouseup.java
...
public class Onmouseup extends AbsEvent
{

    public Onmouseup(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
