...
// Source File Name:   OngroupchangeTag.java
...
//            AbsEventTag, Ongroupchange

public class OngroupchangeTag extends AbsEventTag
{

    public OngroupchangeTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Ongroupchange(stack, req, res);
    }
