...
// Source File Name:   Ontableclick.java
...
public class Ontableclick extends AbsEvent
{

    public Ontableclick(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    {
        return "event-ontableclick";
    }

    protected String getDefaultTemplate()
    {
        return "event-ontableclick-close";
    }

    public void evaluateExtraParams()
    {
        super.evaluateExtraParams();
        addProperty("eventName", "tableclick");
    ...
    private static final String TEMPLATE = "event-ontableclick";
    private static final String TEMPLATE_CLOSE = "event-ontableclick-close";
