...
// Source File Name:   Onfocusin.java
...
public class Onfocusin extends AbsEvent
{

    public Onfocusin(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
