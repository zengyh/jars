...
// Source File Name:   OnfocusoutTag.java
...
//            AbsEventTag, Onfocusout

public class OnfocusoutTag extends AbsEventTag
{

    public OnfocusoutTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Onfocusout(stack, req, res);
    }
