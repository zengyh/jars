...
// Source File Name:   AftertreeinitTag.java
...
//            AbsEventTag, Aftertreeinit

public class AftertreeinitTag extends AbsEventTag
{

    public AftertreeinitTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Aftertreeinit(stack, req, res);
    }

    protected void populateParams()
    {
        super.populateParams();
        Aftertreeinit evt = (Aftertreeinit)component;
