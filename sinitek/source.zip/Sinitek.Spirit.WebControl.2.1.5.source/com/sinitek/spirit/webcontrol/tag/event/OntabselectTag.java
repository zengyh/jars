...
// Source File Name:   OntabselectTag.java
...
//            AbsEventTag, Ontabselect

public class OntabselectTag extends AbsEventTag
{

    public OntabselectTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Ontabselect(stack, req, res);
    }

    protected void populateParams()
    {
        super.populateParams();
        Ontabselect evt = (Ontabselect)component;
        evt.setTabVar(tabVar);
    }
