...
// Source File Name:   OnmousedownTag.java
...
//            AbsEventTag, Onmousedown

public class OnmousedownTag extends AbsEventTag
{

    public OnmousedownTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Onmousedown(stack, req, res);
    }
