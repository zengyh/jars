...
// Source File Name:   OndateselectTag.java
...
//            AbsEventTag, Ondateselect

public class OndateselectTag extends AbsEventTag
{

    public OndateselectTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Ondateselect(stack, req, res);
    }
