...
// Source File Name:   Ongroupchange.java
...
public class Ongroupchange extends AbsEvent
{

    public Ongroupchange(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    {
        return "event-group-close";
    }

    public void evaluateExtraParams()
    {
        super.evaluateExtraParams();
        addProperty("eventName", "change");
    }
    ...
    private static final String TEMPLATE_CLOSE = "event-group-close";
}
