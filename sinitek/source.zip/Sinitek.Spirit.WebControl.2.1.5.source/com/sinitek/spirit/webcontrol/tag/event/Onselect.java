...
// Source File Name:   Onselect.java
...
public class Onselect extends AbsEvent
{

    public Onselect(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
