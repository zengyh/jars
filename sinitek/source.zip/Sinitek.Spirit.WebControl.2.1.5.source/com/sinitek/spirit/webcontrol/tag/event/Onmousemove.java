...
// Source File Name:   Onmousemove.java
...
public class Onmousemove extends AbsEvent
{

    public Onmousemove(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    public void evaluateExtraParams()
    {
        ...
        addProperty("eventName", "mousemove");
    }
