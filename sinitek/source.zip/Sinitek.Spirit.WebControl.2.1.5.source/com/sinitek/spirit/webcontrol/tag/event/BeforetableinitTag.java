...
// Source File Name:   BeforetableinitTag.java
...
//            AbsEventTag, Beforetableinit

public class BeforetableinitTag extends AbsEventTag
{

    public BeforetableinitTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Beforetableinit(stack, req, res);
    }

    protected void populateParams()
    {
        super.populateParams();
        Beforetableinit evt = (Beforetableinit)component;
