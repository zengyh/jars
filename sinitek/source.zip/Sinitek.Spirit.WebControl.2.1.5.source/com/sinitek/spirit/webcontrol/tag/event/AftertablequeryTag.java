...
// Source File Name:   AftertablequeryTag.java
...
//            AbsEventTag, Aftertablequery

public class AftertablequeryTag extends AbsEventTag
{

    public AftertablequeryTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Aftertablequery(stack, req, res);
    }

    protected void populateParams()
    {
        super.populateParams();
        Aftertablequery evt = (Aftertablequery)component;
