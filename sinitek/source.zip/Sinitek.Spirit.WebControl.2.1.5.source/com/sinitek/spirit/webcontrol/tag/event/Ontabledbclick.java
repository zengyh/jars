...
// Source File Name:   Ontabledbclick.java
...
public class Ontabledbclick extends AbsEvent
{

    public Ontabledbclick(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    {
        return "event-ontabledbclick";
    }

    protected String getDefaultTemplate()
    {
        return "event-ontabledbclick-close";
    }

    public void evaluateExtraParams()
    {
        super.evaluateExtraParams();
        addProperty("eventName", "tabledbclick");
    ...
    private static final String TEMPLATE = "event-ontabledbclick";
    private static final String TEMPLATE_CLOSE = "event-ontabledbclick-close";
