...
// Source File Name:   OnsliderchangeTag.java
...
//            AbsEventTag, Onsliderchange

public class OnsliderchangeTag extends AbsEventTag
{

    public OnsliderchangeTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Onsliderchange(stack, req, res);
    }
