...
// Source File Name:   OncolorselectTag.java
...
//            AbsEventTag, Oncolorselect

public class OncolorselectTag extends AbsEventTag
{

    public OncolorselectTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Oncolorselect(stack, req, res);
    }
