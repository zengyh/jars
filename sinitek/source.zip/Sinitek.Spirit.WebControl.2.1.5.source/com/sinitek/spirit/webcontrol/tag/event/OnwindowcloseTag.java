...
// Source File Name:   OnwindowcloseTag.java
...
//            AbsEventTag, Onwindowclose

public class OnwindowcloseTag extends AbsEventTag
{

    public OnwindowcloseTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Onwindowclose(stack, req, res);
    }
