...
// Source File Name:   Ondataselect.java
...
public class Ondataselect extends AbsEvent
{

    public Ondataselect(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    public void evaluateExtraParams()
    {
        ...
        addProperty("eventName", "dataselect");
    }
