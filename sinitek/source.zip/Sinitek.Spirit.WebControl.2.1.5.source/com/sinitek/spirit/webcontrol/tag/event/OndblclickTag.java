...
// Source File Name:   OndblclickTag.java
...
//            AbsEventTag, Ondblclick

public class OndblclickTag extends AbsEventTag
{

    public OndblclickTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Ondblclick(stack, req, res);
    }
