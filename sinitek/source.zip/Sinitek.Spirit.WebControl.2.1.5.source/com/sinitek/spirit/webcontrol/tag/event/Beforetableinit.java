...
// Source File Name:   Beforetableinit.java
...
public class Beforetableinit extends AbsEvent
{

    public Beforetableinit(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    {
        return "event-beforetableinit";
    }

    protected String getDefaultTemplate()
    {
        return "event-beforetableinit-close";
    }

    public void evaluateExtraParams()
    {
        super.evaluateExtraParams();
        addProperty("eventName", "beforetableinit");
    ...
    private static final String TEMPLATE = "event-beforetableinit";
    private static final String TEMPLATE_CLOSE = "event-beforetableinit-close";
