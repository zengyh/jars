...
// Source File Name:   Ondblclick.java
...
public class Ondblclick extends AbsEvent
{

    public Ondblclick(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    public void evaluateExtraParams()
    {
        ...
        addProperty("eventName", "dblclick");
    }
