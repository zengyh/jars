...
// Source File Name:   OnkeypressTag.java
...
//            AbsEventTag, Onkeypress

public class OnkeypressTag extends AbsEventTag
{

    public OnkeypressTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Onkeypress(stack, req, res);
    }
