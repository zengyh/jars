...
// Source File Name:   AftertableinitTag.java
...
//            AbsEventTag, Aftertableinit

public class AftertableinitTag extends AbsEventTag
{

    public AftertableinitTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Aftertableinit(stack, req, res);
    }

    protected void populateParams()
    {
        super.populateParams();
        Aftertableinit evt = (Aftertableinit)component;
