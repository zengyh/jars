...
// Source File Name:   Oncolorselect.java
...
public class Oncolorselect extends AbsEvent
{

    public Oncolorselect(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    {
        return "event-oncolorselect";
    }

    protected String getDefaultTemplate()
    {
        return "event-oncolorselect-close";
    }

    public void evaluateExtraParams()
    {
        super.evaluateExtraParams();
        addProperty("eventName", "colorsselect");
    }
    ...
    private static final String TEMPLATE = "event-oncolorselect";
    private static final String TEMPLATE_CLOSE = "event-oncolorselect-close";
}
