...
// Source File Name:   BeforetablequeryTag.java
...
//            AbsEventTag, Beforetablequery

public class BeforetablequeryTag extends AbsEventTag
{

    public BeforetablequeryTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Beforetablequery(stack, req, res);
    }

    protected void populateParams()
    {
        super.populateParams();
        Beforetablequery evt = (Beforetablequery)component;
