...
// Source File Name:   Ontableorder.java
...
public class Ontableorder extends AbsEvent
{

    public Ontableorder(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    {
        return "event-ontableorder";
    }

    protected String getDefaultTemplate()
    {
        return "event-ontableorder-close";
    }

    public void evaluateExtraParams()
    {
        super.evaluateExtraParams();
        addProperty("eventName", "tableorder");
        addProperty("propertyVar", propertyVar);
        addProperty("orderTypeVar", orderTypeVar);
    }
    ...
    private static final String TEMPLATE = "event-ontableorder";
    private static final String TEMPLATE_CLOSE = "event-ontableorder-close";
