...
// Source File Name:   OnmousemoveTag.java
...
//            AbsEventTag, Onmousemove

public class OnmousemoveTag extends AbsEventTag
{

    public OnmousemoveTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Onmousemove(stack, req, res);
    }
