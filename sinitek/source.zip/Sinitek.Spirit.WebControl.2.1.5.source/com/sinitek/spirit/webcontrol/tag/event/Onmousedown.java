...
// Source File Name:   Onmousedown.java
...
public class Onmousedown extends AbsEvent
{

    public Onmousedown(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    public void evaluateExtraParams()
    {
        ...
        addProperty("eventName", "mousedown");
    }
