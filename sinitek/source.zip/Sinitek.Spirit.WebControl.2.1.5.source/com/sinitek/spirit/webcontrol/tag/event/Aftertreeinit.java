...
// Source File Name:   Aftertreeinit.java
...
public class Aftertreeinit extends AbsEvent
{

    public Aftertreeinit(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    {
        return "event-aftertreeinit";
    }

    protected String getDefaultTemplate()
    {
        return "event-aftertreeinit-close";
    }

    public void evaluateExtraParams()
    {
        super.evaluateExtraParams();
        addProperty("eventName", "aftertreeinit");
    ...
    private static final String TEMPLATE = "event-aftertreeinit";
    private static final String TEMPLATE_CLOSE = "event-aftertreeinit-close";
