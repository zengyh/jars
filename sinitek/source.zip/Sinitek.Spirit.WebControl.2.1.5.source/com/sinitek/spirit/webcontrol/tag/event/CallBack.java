...
public class CallBack extends AbsEvent
{

    public CallBack(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    public void evaluateExtraParams()
    {
        ...
        addProperty("eventName", "callback");
    }
    ...
    private static final String TEMPLATE = "event-callback";
    private static final String TEMPLATE_CLOSE = "event-callback-close";
}
