...
// Source File Name:   OnmouseoverTag.java
...
//            AbsEventTag, Onmouseover

public class OnmouseoverTag extends AbsEventTag
{

    public OnmouseoverTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Onmouseover(stack, req, res);
    }
