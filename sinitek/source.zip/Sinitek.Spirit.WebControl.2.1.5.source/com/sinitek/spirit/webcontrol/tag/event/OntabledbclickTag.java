...
// Source File Name:   OntabledbclickTag.java
...
//            AbsEventTag, Ontabledbclick

public class OntabledbclickTag extends AbsEventTag
{

    public OntabledbclickTag()
    {
    }

    public Component getBean(ValueStack stack, HttpServletRequest req, HttpServletResponse res)
    {
        return new Ontabledbclick(stack, req, res);
    }

    protected void populateParams()
    {
        super.populateParams();
        Ontabledbclick evt = (Ontabledbclick)component;
