...
// Source File Name:   Ondateselect.java
...
public class Ondateselect extends AbsEvent
{

    public Ondateselect(ValueStack stack, HttpServletRequest request, HttpServletResponse response)
    {
    ...
    {
        return "event-ondateselect";
    }

    protected String getDefaultTemplate()
    {
        return "event-ondateselect-close";
    }

    public void evaluateExtraParams()
    {
        super.evaluateExtraParams();
        addProperty("eventName", "dateselect");
    }
    ...
    private static final String TEMPLATE = "event-ondateselect";
    private static final String TEMPLATE_CLOSE = "event-ondateselect-close";
}
