...
//            MetaDBException, IMetaDBContext, MetaDBContextFactory, IEntity, 
//            MetaDBLoggerFactory, ISQLUpdater, IMetaObjectImpl
    ...
    implements IMetaDBContext
{
        ...
        throws MetaDBException
    {
        ...
        {
            IMetaObject ret = cacheContext.loadFromCache(entity, id);
            if(ret == null)
        ...
        try
        {
            IMetaObject ret = (IMetaObject)session.get(entity.getEntityName(), Integer.valueOf(id));
            if(ret == null)
                throw new MetaDBCoreException("0032", new Object[] {
                    entity.getEntityName(), Integer.valueOf(id)
                });
    ...
    {
        checkClose();
        IProperty property = checkUniqueProperty(entity, uniquePropertyName);
        if(isFromCache && cacheContext != null && entity.isIdCacheSupport())
        {
    ...
    public void close()
        throws MetaDBException
    {
        MetaDBContextFactory factory;
        factory = MetaDBContextFactory.getInstance();
        if(isClosed)
