...
//            MetaDBContextImpl, MetaDBCoreException, MetaDBContextFactory, IMetaDBContext, 
//            IMetaDBTemplateExecutor, IEntity, IMetaObject
...
public class MetaDBTemplate
{
    ...
    public void callExecutor(IMetaDBTemplateExecutor executor)
    {
        ...
        ctx = factory.createContext(createType);
        try
        {
            ctx.begin();
